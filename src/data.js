...
export const Backend = {
  ...
  equipments: {
    ...
    equipmentstemp: {
      url: Config.tecrepApiEquipmentsUrl + '/api/v1/private/auth/equipmentstemp',
    },
    pending: {
      url: Config.tecrepApiEquipmentsUrl + '/api/v1/private/auth/equipmentstemp/pending'
    },
    completed: {
      url: Config.tecrepApiEquipmentsUrl + '/api/v1/private/auth/equipmentstemp/completed'
    },
    uploadTemp: {
      url: Config.tecrepApiEquipmentsUrl + '/api/v1/private/auth/equipmentstemp/upload'
    },
    sendValidEquipments: {
      url: Config.tecrepApiEquipmentsUrl + '/api/v1/private/auth/equipmentstemp/send-valid-equipments'
    },
    jobStatus: {
      url: Config.tecrepApiEquipmentsUrl + '/api/v2/private/auth/ancillaryequipments/import/status'
    }
  },
  resources: {
    dashboard: {
